...
(
    ...
    where 
        a.IdCampaign = 'EFMAX' and a.Disponible = 1 and STR(b.Telefono,8,0) like '[5,6,7,8,9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]' and b.Estado = 1 and a.Estado = 1 and (a.LastCalled <= DATEADD(MONTH,-2,GETDATE()) OR A.LastCalled IS NULL)
),
